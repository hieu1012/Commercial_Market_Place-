...
export default function Screen2  ({navigation}) {
  ...
  useEffect(()=>{
    fetch('https://fakestoreapi.com/products')
      ...
      .then(json => {
        ...
        const filteredProducts = json.filter(item => item.category === "men's clothing");
  ...
  const renderItem = ({item})=>{
    return (
        <TouchableOpacity onPress={() => navigation.navigate('ManHinh4', { product: item })}>
          <View style={styles.item_product}>
      ...
      {/* Danh  sản phẩm */}
        ...
        {/* Box title sales */}
          <View style={{
            ...
            <View style={[styles.box_Title_Sales, {backgroundColor:'#EBFDFF'}]}>
              <Text style={[styles.title_Sales,{color:'#39BACD'}]}>Best Sales</Text>
            </View>
